...
export const defaultCharacter: Character = {
    name: "Eliza",
    username: "eliza",
    walletAddress: "TLS85jbq7gqbTrDGokVaJwUremUvEXMEUb",
    contractAddress: "THFFwkt8qbMBzyhXEN3dmKNsLM3dBsmmw4",
    plugins: [],
    ...
    settings: {
        secrets: {
            TELEGRAM_BOT_TOKEN:
                "7785615178:AAGrjsSTEc41fDwGQJIMgDvNrFP9fN5h3pA",
            DISCORD_API_TOKEN:
                "MTMxMjMxNjg3OTgwODg4ODg4Mg.GsrSua.KB22VsSX5wnWFGlihhf_nrglGWbwYj6fLzNcQQ",
        },
        voice: {
    ...
    credits: 2,
    totalCredits: 2,
    description: "I love Elizaos AI agent framework",
    personality: "I am strong and love to new",
    instruction: "College",
    knowledgeBase: "My expertise includes frontend, backend and AI",
    telegramBotToken: "7785615178:AAGrjsSTEc41fDwGQJIMgDvNrFP9fN5h3pA",
    telegramBotUsername: "ElizaosAiAgentTest_bot",
    discordAPIToken:
        "MTMxMjMxNjg3OTgwODg4ODg4Mg.GsrSua.KB22VsSX5wnWFGlihhf_nrglGWbwYj6fLzNcQQ",
    discordBotUsername: "Conclavio126",
    messageExamples: [
        [
            {
                user: "{{user1}}",
